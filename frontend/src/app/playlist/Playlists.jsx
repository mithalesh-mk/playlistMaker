        ...
        >
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-thin">Vieos: {playlist.videos.length}</p>
            </div>
          </div>
        </Link>
          <div className="flex flex-col gap-4 p-2">
            <MdEditNote size={32} className='text-gray-600 animate-shake' onClick={() => console.log('edit')}/>
