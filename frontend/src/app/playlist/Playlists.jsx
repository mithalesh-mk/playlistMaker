...
const Playlists = () => {
  ...
  if(!loading && playlists.length === 0) return (
    <div className="flex flex-col justify-center items-center h-screen xl:h-[calc(100vh-100px)]">
      <ListVideo size={400} className='text-gray-700' />
      <p className="text-gray-200 text-lg mt-5">No playlists</p>
    </div>
  )
              ...
              <div className="flex justify-between items-center mt-4 text-gray-400 text-sm">
                <div className="flex gap-3">
                  <span className="flex items-center gap-1 hover:text-gray-200 cursor-pointer transition-all">
                    <Heart size={20} fill='red' stroke='none' /> {playlist.likes.length}
                  </span>
                  <span className="flex items-center gap-1 hover:text-gray-200 cursor-pointer transition-all">
                    <FaThumbsDown /> {playlist.dislikes.length}
                  </span>
                </div>
                  <span className="flex border px-2 rounded-md border-white items-center transition-all">
                      {playlist.category}
                  </span>
